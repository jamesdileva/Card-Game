-- Seed data migrated from cardgamedata2.sql (PostgreSQL dump, 2026-04-06).
-- Idempotent: safe to re-run via `npm run db:init`.
...
INSERT OR IGNORE INTO inventory (id, user_id, card_id, rarity) VALUES
...
INSERT OR IGNORE INTO deck (id, user_id, slot, card_id) VALUES
(736, 8, 0, NULL),
(737, 8, 1, NULL),
(738, 8, 2, NULL),
(445, 4, 0, 'wild_symbol'),
